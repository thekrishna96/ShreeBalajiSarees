    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+8px)] right-0 bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-2xl shadow-2xl w-[420px] text-ui-fg-base"
